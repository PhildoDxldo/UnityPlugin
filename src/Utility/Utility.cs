...
namespace ModIO
{
    public static class Utility
    {
        ...
        /// <summary>Wrapper function for determining if a Web Request has errored.</summary>
        public static bool IsError(this UnityEngine.Networking.UnityWebRequest request)
        {
